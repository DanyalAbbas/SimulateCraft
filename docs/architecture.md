...
| Piece | Role |
|---|---|
| [`Runner`](reference/core/runner.md) | Async tick loop, pause/step, timeouts |
...
| [`EventBus`](reference/core/events.md) | Typed outbound events + inbound chat/control |
...
- Live RPCs: `get_state`, `get_map`, `perform_action`
